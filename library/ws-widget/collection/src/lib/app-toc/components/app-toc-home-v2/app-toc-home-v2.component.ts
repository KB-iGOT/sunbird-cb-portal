...
import { NonReleventFeedbackDialogComponent } from '../../../_common/non-relevent-feedback-dialog/non-relevent-feedback-dialog.component'
...
import { HandleClaimService } from '../../../_common/content-toc/content-services/handle-claim.service'
import { NsCardContent } from '../../../card-content-v2/card-content-v2.model'
import { ContentRatingV2DialogComponent } from '../../../_common/content-rating-v2-dialog/content-rating-v2-dialog.component'
...
export class AppTocHomeV2Component implements OnInit, OnDestroy, AfterViewChecked, AfterViewInit {
  ...
  firstResourceLink: any | null = null
...
/*******  6d94c646-254c-44d6-a7c3-90bdb9507318  *******/    if (this.baseContentReadData && this.baseContentReadData.identifier) {
  ...
  private setupBatchControlSubscription() {
    this.batchControl.valueChanges.subscribe((batch: any) => {
      if (batch) {

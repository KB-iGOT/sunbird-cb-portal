...
import { PlayerSurveyFormQuestionComponent } from '../survey-form-question/survey-form-question.component'
import { CommonModule } from '@angular/common'

@Component({
  selector: 'ws-widget-player-survey-form-section',
  imports: [PlayerSurveyFormQuestionComponent, CommonModule],
  templateUrl: './survey-form-section.component.html',
  styleUrls: ['./survey-form-section.component.scss']
})
export class PlayerSurveyFormSectionComponent {

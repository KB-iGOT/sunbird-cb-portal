...
import { IGridLayoutDataMain } from '../../../../../../../grid-layout/grid-layout.model'
import { NsContentStripMultiple } from '../../../../../../../content-strip-multiple/content-strip-multiple.model'
import { ISelectorResponsive } from '../../../../../../../selector-responsive/selector-responsive.model'
import { NsGalleryView } from '../../../../../../../gallery-view/gallery-view.model'
import { NsWidgetLayoutTab } from '../../../../../../../layout-tab/layout-tab.model'
    ...
    const recursiveFunc = (widget: NsWidgetResolver.IRenderConfigWithAnyData): string => {
      ...
      switch (widget.widgetSubType) {
        ...
        case 'tabLayout':
          ...
          returnWidget.data = undefined as any
          tabWidget.tabs.forEach((v: { tabContent: NsWidgetResolver.IRenderConfigWithAnyData; tabKey: any; tabTitle: any }) => {
        ...
        case 'selectorResponsive':
          ...
          selectorWidget.selectFrom.forEach((v: { widget: NsWidgetResolver.IRenderConfigWithAnyData; minWidth: any; maxWidth: any }) => {
        ...
        case 'galleryView':
          ...
          galleryWidget.cardMenu.forEach((v: any) => {
            const child = recursiveFunc(v.widget)
            returnData[child].parent = id
        ...
        case 'contentStripMultiple':
          ...
          contentStripWidget.strips.forEach((v: any) => {
            ...
            if (v.preWidgets && v.preWidgets.length) {
              v.preWidgets.forEach((preWidget: NsWidgetResolver.IRenderConfigWithAnyData) => {
            ...
            if (v.postWidgets && v.postWidgets.length) {
              v.postWidgets.forEach((postWidget: NsWidgetResolver.IRenderConfigWithAnyData) => {

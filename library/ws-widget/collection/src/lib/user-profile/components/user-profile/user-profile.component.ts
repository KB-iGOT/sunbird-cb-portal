...
import { FormGroup, FormControl, Validators, UntypedFormArray, UntypedFormBuilder, AbstractControl, ValidatorFn } from '@angular/forms'
...
import { IMAGE_MAX_SIZE, PROFILE_IMAGE_SUPPORT_TYPES } from '../../../constants/upload'
...
export class UserProfileComponent implements OnInit, OnDestroy {
  ...
  otpSend = false
  otpVerified = false
  OTP_TIMER = this.environment.resendOTPTIme

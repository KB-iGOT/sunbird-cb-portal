...
import { AppTocService, ResetRatingsService, ViewerDataService, ViewerUtilService, WidgetContentService } from '@sunbird-cb/toc'
import { ContentRatingV2DialogComponent, NsContent, RatingService } from '@sunbird-cb/collection'

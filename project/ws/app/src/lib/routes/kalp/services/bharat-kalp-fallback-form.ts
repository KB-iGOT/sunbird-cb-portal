                ...
                tabs: [
                  {
                    ...
                    cards: [
                      {
                        name: 'Introduction To Bharatiya Nyaya Sanhita, 2023',
                        identifier: '',
                        posterImage: '',
                        duration: '52 min',
                        category: 'Course',
                        org: 'By Karmayogi Bharat',
                        orgLogo: '',
                        rating: '4.4',
                      },
                      {
                        name: 'Practice Question: Introduction to Administrative',
                        identifier: '',
                        posterImage: '',
                        duration: '14 hrs',
                        category: 'Course',
                      ...
                      {
                        name: 'Digital India: Foundations of e-Governance',
                        identifier: '',
                        posterImage: '',
                  ...
                  },
                  {
                    ...
                    cards: [
                      {
                        name: 'Civil Services Leadership Program',
                        identifier: '',
                        posterImage: '',
                        duration: '16 weeks',
                        category: 'Program',
                        org: 'By Mission Karmayogi',
                        orgLogo: '',
                        rating: '4.5',
                      },
                      {
                        name: 'Bharat Kalp Advanced Governance',
                        identifier: '',
                        posterImage: '',
                        duration: '8 weeks',
                        category: 'Program',
                  ...
                  },
                  {
                    ...
                    cards: [
                      {
                        name: 'Live Webinar: Digital Governance & Policy',
                        identifier: '',
                        posterImage: '',
                        duration: '2 hrs',
                        category: 'Event',
                      ...
                      {
                        name: 'Expert Panel: Leadership in Civil Services',
                        identifier: '',
                        posterImage: '',
                  ...
                  },
                  {
                    ...
                    cards: [
                      {
                        name: 'BNS 2023 – Week 3 Assessment',
                        identifier: '',
                        posterImage: '',
                        duration: '30 min',
                        category: 'Assessment',

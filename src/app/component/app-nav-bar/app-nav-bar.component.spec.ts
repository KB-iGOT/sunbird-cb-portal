...
const mockDomainConfService = {
  getDomainAppLogo: jest.fn(() => 'domain-logo.png'),
  getDomainRedirectPath: jest.fn(() => '/domain/home')
}
...
describe('AppNavBarComponent', () => {
  ...
  beforeEach(() => {
    ...
    // Mock window.screen
    Object.defineProperty(globalThis as any, 'screen', {
      writable: true,
  ...
  describe('Constructor', () => {
    ...
    it('should set showLangDropdown based on URL', () => {
      ; (globalThis as any).location.href = 'http://localhost:4200/karmayogi-saptah'
  ...
  describe('ngOnInit', () => {
    ...
    it('should initialize app icons and configuration', () => {
      ...
      expect(component.primaryNavbarBackground as any).toBe(mockConfigurationsService.primaryNavBar as any)
      expect(component.pageNavbar as any).toBe(mockConfigurationsService.pageNavBar as any)
      expect(component.primaryNavbarConfig as any).toBe(mockConfigurationsService.primaryNavBarConfig as any)
      expect(mockDomainConfService.getDomainAppLogo).toHaveBeenCalled()
      expect(mockDomainConfService.getDomainRedirectPath).toHaveBeenCalled()
      expect(component.redirectPath).toBe('/domain/home')
    })
    ...
    describe('getMyCount', () => {
      ...
      it('should handle error when fetching notifications count', () => {
        ...
        expect(component.notificationsCount).toBe(0)
        expect(consoleSpy).toHaveBeenCalledWith('Error while fetching notifications count', jasmine.any(Error))
    ...
    describe('routeSubs', () => {
      ...
      it('should hide navbar for viewer pages', () => {
        const navigationEnd = new NavigationEnd(1, '/viewer/xyz', '/viewer/xyz')
    ...
    describe('ngOnDestroy', () => {
      it('should unsubscribe from myNotificationsSubscription', () => {
        ...
        (component as any).myNotificationsSubscription = mockSubscription as any
      ...
      it('should not throw error when myNotificationsSubscription is undefined', () => {
        (component as any).myNotificationsSubscription = undefined as any

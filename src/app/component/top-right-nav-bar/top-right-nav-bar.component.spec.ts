...
describe('TopRightNavBarComponent', () => {
  ...
  describe('callXMLRequest', () => {
    it('should create XMLHttpRequest and configure it', () => {
      ...
      expect(mockXHR.open).toHaveBeenCalledWith(
        'GET',
        expect.stringContaining('https://desk.zoho.in/support/GenerateCaptcha?action=getNewCaptcha&_='),
        true
      );
  ...
  describe('showDialog', () => {
    it('should open confirm dialog and handle positive result', () => {
      ...
      expect(mockDialog.open).toHaveBeenCalledWith(expect.anything(), data);

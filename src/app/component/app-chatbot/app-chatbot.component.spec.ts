...
describe('AppChatbotComponent', () => {
  ...
  beforeEach(() => {
    ...
    configSvcMock = {
      userProfile: { firstName: 'Test', profileImage: '', professionalDetails: [] },
      iGOTAIConfig: null,
    ...
    httpMock = {
      get: jest.fn().mockReturnValue(of('<html>zoho</html>')),
    }

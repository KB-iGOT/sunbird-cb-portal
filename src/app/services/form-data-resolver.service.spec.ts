...
describe('FormDataResolverService', () => {
  ...
  describe('resolve', () => {
    ...
    // it('should use default pageType when not provided in route data', (done) => {
    //   // Create route without pageType
    //   const routeWithoutPageType = {
    //     data: {
    //       pageKey: 'test-page-key'
    ...
    //   // Mock form service to fail so we can check the HTTP URL
    //   mockFormSvc.formReadData.mockReturnValue(throwError('API Error'));

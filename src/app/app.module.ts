...
import {
  ErrorResolverModule, TourModule, PipeContentRoutePipe,
  StickyHeaderModule,
  AvatarPhotoModule,
  BtnAppsModule,
  BtnCallModule,
...
import * as cfg from '@sunbird-cb/collection'

console.log(cfg)
import { WIDGET_REGISTRATION_CONFIG } from '@sunbird-cb/collection/src/lib/registration.config'
console.log('WIDGET_REGISTRATION_CONFIG--', WIDGET_REGISTRATION_CONFIG)
console.log('WIDGET_REGISTRATION_LIB_CONFIG--', WIDGET_REGISTRATION_LIB_CONFIG)

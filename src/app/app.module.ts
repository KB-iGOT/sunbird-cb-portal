...
import { ConfigService, DiscussionUiModule } from '@sunbird-cb/discussions-ui-v8'
...
import { SearchModule, ProfileV3Module, QuickTourModule, AppTocResolverService } from '@sunbird-cb/collection'
// @Injectable()

...
describe('PublicWelcomeComponent', () => {
  ...
  describe('searchOrgs', () => {
    beforeEach(() => {
      component.init()
        ; (jest.spyOn(component as any, 'filterOrgsSearch') as any).mockResolvedValue(undefined)
    })
  ...
  describe('sendOtp', () => {
    ...
    it('should send OTP successfully', () => {
      ...
      expect((globalThis as any).alert).toHaveBeenCalledWith('OTP send to your Mobile Number')

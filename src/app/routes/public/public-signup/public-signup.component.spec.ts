...
describe('PublicSignupComponent', () => {
  ...
  describe('clearValues', () => {
    it('should clear organisation value and heirarchyObject', () => {
      component.registrationForm.get('organisation')?.setValue('test org');
  ...
  describe('mdoRedirect', () => {
    it('should redirect to MDO list page', () => {
      ...
      expect(window.location.href).toBe('https://example.com/#/mdoList#mdoUserList');
    });
  });
  ...
  describe('OrgsSearchChange', () => {
    it('should subscribe to organisation value changes', () => {
      ...
      component.registrationForm.get('organisation')?.setValue('test');
  ...
  describe('orgClicked', () => {
    it('should handle organization selection', () => {
      ...
      expect(component.registrationForm.get('organisation')?.value).toBe('Test Organization');
  ...
  describe('sendOtp', () => {
    ...
    it('should handle invalid mobile number', () => {
      component.registrationForm.get('mobile')?.setValue('invalid');
  ...
  describe('signup', () => {
    ...
    it('should handle captcha error', () => {
      ...
      expect(component.disableBtn).toBe(false);
      expect(mockSnackBar.open).toHaveBeenCalledWith('reCAPTCHA validation failed: Captcha failed');
    });
  });
  ...
  describe('callXMLRequest', () => {
    it('should make XML request for captcha', () => {
      ...
      //   if (id === 'zsCaptchaUrl' || id === 'zsCaptchaLoading' || id === 'zsCaptcha' || id === 'refreshCaptcha') {
      //     return mockElement;
      //   }
      //   return null;
      // });
    ...
    it('should handle XHR error gracefully', () => {
      ...
      // // Simulate XHR response with invalid JSON
      // if (mockXHR.onreadystatechange) {
      //   mockXHR.onreadystatechange();
      // }
...
describe('Integration Tests', () => {
  ...
  it('should handle organization search and selection flow', async () => {
    ...
    expect(component.registrationForm.get('organisation')?.value).toBe('Test Organization 1');
    expect(component.hideOrg).toBe(true);

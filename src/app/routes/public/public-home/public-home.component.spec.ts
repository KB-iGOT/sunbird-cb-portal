...
describe('PublicHomeComponent', () => {
  ...
  it('should initialize with correct default values', () => {
    ...
    expect(component.learnNetworkSection).toEqual([]);
  ...
  it('should set language from localStorage during initialization', () => {
    ...
    // Call loadData which is called in the constructor
    component.loadData();
    
    expect(localStorage.getItem).toHaveBeenCalledWith('websiteLanguage');
